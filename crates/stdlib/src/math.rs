...
pub fn math_lib<'gc>(ctx: vm::Context<'gc>, lib: &mut MagicSet<'gc>) {
    ...
    lib.insert(ctx.intern("cos"), MagicConstant::new_ptr(&ctx, cos.into()));
    ...
    lib.insert(ctx.intern("sin"), MagicConstant::new_ptr(&ctx, sin.into()));
    ...
    lib.insert(ctx.intern("abs"), MagicConstant::new_ptr(&ctx, abs.into()));
    ...
    lib.insert(
        ctx.intern("sqrt"),
        MagicConstant::new_ptr(&ctx, sqrt.into()),
    );
    ...
    lib.insert(ctx.intern("sqr"), MagicConstant::new_ptr(&ctx, sqr.into()));
    ...
    lib.insert(
        ctx.intern("round"),
        MagicConstant::new_ptr(&ctx, round.into()),
    );
    ...
    lib.insert(
        ctx.intern("floor"),
        MagicConstant::new_ptr(&ctx, floor.into()),
    );
}
